...
<div class="row">
    <div class="large-12 columns">
        ...
        <lable for "question1" >Question 1:Where ist plain javascript executed?</lable>
        <form>
            <input type="radio" name="question1" value=0 > On the server side.
            <br>
            <input type="radio" name="question1" value=0 > In the browser from the client.
        </form>
        <footer class="row">
            <div class="large-12 columns">
                <hr>
